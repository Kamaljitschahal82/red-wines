...
```{r echo=FALSE, Multivariate_Plots}
ggplot(data = subset(reds, quality != 6 & quality != 5), aes(y = citric.acid, x = alcohol, colour=quality)) +
  geom_point(size=3)
```
...
```{r echo=FALSE, Multivariate_Plots}
ggplot(data = subset(reds, quality != 6 & quality != 5), aes(y = volatile.acidity, x = alcohol, colour=quality)) +
  geom_point(size=3)
```
...
```{r echo=FALSE, Multivariate_Plots}
ggplot(data = subset(reds, quality != 6 & quality != 5), aes(y = volatile.acidity, x = citric.acid, colour=quality)) +
  geom_point(size=3)
```
...
```{r}
ggplot(data = subset(reds, quality != 6 & quality != 5), aes(y = citric.acid, x = alcohol, colour=quality, size=volatile.acidity)) +
  geom_point()
```
