...
Another three features are weakly correlated with quality: sulphates, density and pH.

### Did you observe any interesting relationships between the other features (not the main feature(s) of interest)?

Citric.acid is negatively correlated with both volatile.acidity and pH. Alcohol is inversely correlated with density. This may explain why density and pH, that are (I presume) hard to detect without tools are correlated with quality, even if weakly.
...
It looks like very high volatile.acidity values almost completely prevent a wine to achieve a high quality rating. There are some high rated wines with very low citric acid and alcohol content, and even with a slightly high volatile acidity (around 0.8), but higher than that there is almost none. 
